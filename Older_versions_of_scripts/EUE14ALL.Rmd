...
---
# title: "Analyses of E14 Electroporated Cells with Seurat Workflow"
...
# Inspecting first two principal components
```{r}
...
# Visuzalizing the inferred lineage for the single-trajectory data with points colored by pseudotime. That is, the color of the points represent pseudotime and not clusters
```{r fig.height=10, fig.width=10}
...
# Lineage structure visualized cluster-wise
```{r fig.height=10, fig.width=10}
